...
<div class="container">
    <div class="card">
        <h3 class="text-center mt-2">Registar Pacotes</h3>
        @if ($errors->any())
        ...
        <form action="{{ route('pacote.salvar') }}" method="post" id="form-registar" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row m-2">
                ...
                <div class="form-group col-lg-6 col-md-6">
                    ...
                    <input id="nomePacote" name="nomePacote" value="{{ old('nomePacote') }}" type="text" class="form-control">
                </div>
    
                <div class="form-group col-lg-6 col-md-6">
                    <label for="armazenamento" class="col-form-label">Armazenamento</label>
                    <input id="armazenamento" name="armazenamento" value="{{ old('armazenamento') }}" type="text" class="form-control">
                </div>

                <div class="form-group col-lg-6 col-md-6">
                    <label for="qtdSite" class="col-form-label">Qtd Sites</label>
                    <input id="qtdSite" name="qtdSite" value="{{ old('qtdSite') }}" type="text" class="form-control">
                </div>
                ...
                <div class="form-group col-lg-6 col-md-6">
                    ...
                    <input id="numContaEmail" value="{{ old('numContaEmail') }}" name="numContaEmail" type="text" class="form-control">
                </div>
                ...
                <div class="form-group col-lg-6 col-md-6">
                    ...
                    <input id="QtdBd" value="{{ old('QtdBd') }}" name="QtdBd" type="text" class="form-control">
                </div>

                <div class="form-group col-lg-6 col-md-6">
                    <label for="preco" class="col-form-label">Preço</label>
                    <input id="preco" value="{{ old('preco') }}" name="preco" type="text" class="form-control">
                </div>

                <div class="form-group col-lg-12 col-md-12">
                    <label for="url" class="col-form-label">ULR</label>
                    <input id="url" value="{{ old('URL') }}" name="url" type="text" class="form-control">
                </div>
