...
<div class="container">
    <div class="card">
        <h3 class="text-center mt-2">Alterar Dominios</h3>
        @if ($errors->any())
        ...
        <form action="{{ route('dominio.alterar') }}" method="post" id="form-registar" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row m-2">
                ...
                <div class="form-group col-lg-6 col-md-6">
                    ...
                    <input id="ltd" name="ltd" value="{{$dominio->ltd }}" type="text" class="form-control">
                </div>
    
                <div class="form-group col-lg-6 col-md-6">
                    <label for="registro" class="col-form-label">Registro</label>
                    <input id="registro" name="registro" value="{{ $dominio->registro }}" type="text" class="form-control">
                </div>

                <div class="form-group col-lg-6 col-md-6">
                    <label for="transferencia" class="col-form-label">Tranferencia</label>
                    <input id="transferencia" name="transferencia" value="{{ $dominio->transferencia }}" type="text" class="form-control">
                </div>

                <div class="form-group col-lg-6 col-md-6">
                    <label for="renovacao" class="col-form-label">Renovação</label>
                    <input id="renovacao" value="{{ $dominio->renovacao}}" name="renovacao" type="text" class="form-control">
                </div>

                <div class="form-group col-lg-12 col-md-12">
                    <label for="descricao" class="col-form-label">Descrição</label>
                    <input id="descricao" value="{{ $dominio->descricao }}" name="descricao" type="text" class="form-control">
                    <input type="hidden" name="dominio_id" value="{{$dominio->id}}">
                </div>
